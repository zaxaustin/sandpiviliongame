 ...
 { slug:'waking-the-residents', tradition:'Practice', title:'Waking the Residents — a local AI, plainly explained', added:'2026-07-28',
   ...
   doc:{ summary:'Quill, the Monk and Sebastian are asleep until a local AI runs on your own machine. What that means, why it is worth doing, and the four steps to do it — written for someone who has never installed one.',
     sections:[
       ...
       {heading:'The four steps', body:'One — go to ollama.com and install it, like any other program. Two — open a terminal and type: ollama pull llama3.1:8b. That downloads about five gigabytes; make tea. Three — come back here, press Esc, and choose Manage AI connections. Four — press Detect. It looks at your own machine on port 11434 and finds what you have pulled. That is it; the residents wake.'},
       {heading:'Which model to pull', body:'Start with llama3.1:8b. It is small enough to be quick on almost any machine and good enough to be genuinely useful. If your computer is strong, larger models think better and answer slower — the Mountain Monk is deliberately given the largest one you have, because his questions deserve the time. If your machine struggles or runs hot, stay small; a fast honest answer beats a slow clever one you gave up waiting for.'},
